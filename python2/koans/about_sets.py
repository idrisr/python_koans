...
class AboutSets(Koan):
    def test_sets_make_keep_lists_unique(self):
        ...
        h = ['MacLeod', 'Ramirez', 'Matunas', 'Malcolm']

        self.assertEqual(set(h), there_can_only_be_only_one)
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual(scotsmen | warriors,\
                set(['MacLeod', 'Wallace', 'Willie', 'Leonidas']))
        self.assertEqual(scotsmen & warriors, set(['MacLeod', 'Wallace']))
